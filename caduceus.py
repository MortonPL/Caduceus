...
from src.problemfinder import analyze_flags_all, analyze_movable_all, analyze_samename_all
from src.problemsolver import solve_movable_all, solve_samename_all, solve_flags_all
