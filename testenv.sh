...
echo -n "A" > env/X/z     && touch env/X/z      -m -t 199509260000.03   && chmod u+x env/X/z

echo -n "A" > env/Y1/a    && touch env/Y1/a     -m -t 199509260000.04
echo -n "C" > env/Y1/c\;  && touch env/Y1/c\;   -m -t 199509260000.05   && chmod g+w env/Y1/c\;
...
echo -n "D" > env/Y2/d    && touch env/Y2/d     -m -t 199509260000.08   && chmod u+rwx,g+rwx,a+rwx env/Y2/d
